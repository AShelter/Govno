...
int nAnonymizeGovnoAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Govno
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Govno
    // Mac: ~/Library/Application Support/Govno
    // Unix: ~/.Govno
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Govno";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Govno.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "govnod.pid"));
