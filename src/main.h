...
static const int64_t STATIC_POS_REWARD = 3.5 * COIN; //Constant reward of 3.5 GOVNO per COIN
static const int64_t TARGET_SPACING = 3 * 60; // 3 min per Block
static const int64_t TARGET_SPACING2 = 3 * 60; // 3 min per Block
...
static const int64_t MAX_MONEY = 3500000000 * COIN; // 1M PoW coins
...
inline int64_t GetMNCollateral(int nHeight) { return 250000; }
