...
const string strMessageMagic = "Govno Signed Message:\n";
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(nBestHeight >= 5000 && nBestHeight <= 100000){
      nSubsidy = 2000 * COIN;
    } else if(nBestHeight <= 200000 && nBestHeight > 100000){
      nSubsidy = 1000 * COIN;
    } else if(nBestHeight <= 400000 && nBestHeight > 200000){
      nSubsidy = 500 * COIN;
    } else if(nBestHeight <= 800000 && nBestHeight > 400000){
      nSubsidy = 250 * COIN;
    } else if(nBestHeight <= 1600000 && nBestHeight > 800000){
      nSubsidy = 125 * COIN;
    } else{
      nSubsidy = 75 * COIN;
    }
