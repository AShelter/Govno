...
public:
	CMainParams() {
		...
		const char* pszTimestamp = "Govno coin has born 08, March 2018";
		...
		vout.resize(1);
		vout[0].SetEmpty();
		CTransaction txNew(1, 1520103884, vin, vout, 0);
		genesis.vtx.push_back(txNew);
		genesis.hashPrevBlock = 0;
		genesis.hashMerkleRoot = genesis.BuildMerkleTree();
		genesis.nVersion = 1;
		genesis.nTime = 1520103884;
		genesis.nBits = 0;
		genesis.nNonce = 0;
		...
		//vSeeds.push_back(CDNSSeedData("0", "80.211.155.88"));
		//vSeeds.push_back(CDNSSeedData("1", "80.211.159.182"));
		//vSeeds.push_back(CDNSSeedData("2", "80.211.177.103"));
		//vSeeds.push_back(CDNSSeedData("3", "80.211.141.70"));
